  ...
  <div class="p-4 w-full">
    ...
    <div class="flex flex-col">
      <form action="" class="flex flex-col">
        ...
        <!-- Campo nombre del empleado -->
        <div class="flex flex-col pt-4">
          <label for="name" class="text-lg">Nombre de la Compañia</label>
          <input type="text" id="namecomp" name="namecomp" placeholder="Ingrese el nombre " class="shadow border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight
          @error('namecomp')
              border-red-500
          @enderror" 
          value="{{old('namecomp')}}">
